...
class TestCreateIgvSession(unittest.TestCase):
    ...
    def test_attribute_handling(self):
        ...
        self.assertRaises(
            ...
            genome=GENOME.HG38,
            genome_path="",
            bam_color_by=[AlignmentColorByOption.NONE],
            bam_color_by_tag=[""],
            bam_display_mode=[AlignmentDisplayModeOption.COLLAPSED],
        ...
        self.assertRaises(
            ...
            # Relevant arguments
            files=[self.input_bam],
            bam_group_by=[AlignmentGroupByOption.NONE, AlignmentGroupByOption.NONE],
            # Other arguments
            names=[],
            heights=[],
            genome=GENOME.HG38,
        ...
        self.assertRaises(
            ...
            # Relevant arguments
            files=[self.input_bam],
            bam_color_by=[AlignmentColorByOption.TAG],
            bam_color_by_tag=["PS"],
            # Other arguments
            names=[],
            heights=[],
            genome=GENOME.HG38,
            genome_path="",
            bam_group_by=[AlignmentGroupByOption.NONE],
            bam_display_mode=[AlignmentDisplayModeOption.COLLAPSED],
            bam_hide_small_indels=[False],
            bam_small_indel_threshold=[0],
            bam_show_coverage=[False],
